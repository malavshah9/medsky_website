...
?>
  ...
  -->
            <text align="center"><h1>Your Patients</h1></text>
...
$conn=new pre();
$result=$conn->viewmypatient($_SESSION["id"]);
$cnt=1;
while($row=$result->fetch_assoc())
{
  echo '<tr align="center">
  <th scope="col">'.$cnt.'</a></th>
  <th scope="col">'.$row["usr_name"].'</a></th>
  <th scope="col">'.$row["usr_mno"].'</a></th>
  <th scope="col">'.$row["usr_gen"].'</a></th>
  <th scope="col">'.$row["MAX(p.pres_date)"].'</a></th>
  </tr>';
  $cnt++;
}
?>
